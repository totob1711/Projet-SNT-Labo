...
class Users:
    ...
    def generate_password(self, size):
        ...
        for i in range(size):
            self.__password += ''.join(secrets.choice(alphabet))
...
# Creation de la class scientifique qui herite de la classe user
class Scientifique(Users):
